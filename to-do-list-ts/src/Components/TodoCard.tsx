...
const TodoCard: React.FC<Props> = ({ currentTodo, alltodos, alltodosSetter, index }) => {
  ...
  return (
    <Draggable draggableId={JSON.stringify(currentTodo.id)} index={index}>{(provided) => 

      <form className='todos__single' onSubmit={(e) => handleSubmit(e)} {...provided.draggableProps} {...provided.dragHandleProps} ref={provided.innerRef}>
        {
          edit ?
            <>
